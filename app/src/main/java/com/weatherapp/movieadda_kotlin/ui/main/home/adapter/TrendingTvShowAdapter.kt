...
class TrendingTvShowAdapter(var list: List<TrendingTvShow.Result>) :RecyclerView.Adapter<TrendingTvShowAdapter.TrendingTvShowViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TrendingTvShowViewHolder, position: Int) {
        ...
        holder.trending_m_name.text = list.get(position).name
